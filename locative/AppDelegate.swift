...
//        var userMailadress = UserDefaults.standard.string(forKey: "userMailadress")
//        var userPassword = UserDefaults.standard.string(forKey: "userPassword")
//        if userMailadress != nil && userPassword != nil{
//            Auth.auth().signIn(withEmail: userMailadress!, password: userPassword!) { (user, error) in
//                if error == nil {
//                    UserDefaults.standard.set(userMailadress, forKey: "userMailadress")
